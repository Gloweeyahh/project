  ...
  return (
    <>
      ...
      <motion.div 
        ...
        className="md:hidden absolute top-full left-0 w-full bg-white/80 dark:bg-slate-950/95 backdrop-blur-xl border-t border-gray-300 dark:border-white/10 flex flex-col gap-4 p-6"
      >
        {links.map((link) => (
          <Link 
            key={link.name}
